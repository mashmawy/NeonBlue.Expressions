...
{
    public class DateTimeGreaterThanOrEqualOperatorUniTest
    {
        [Fact]
        public void DateTimeGreaterThanOrEqualDateTimeReturnCorrectValueAndValueType()
        {
            // Given 
   ...
   [Fact]
        public void DateTimeGreaterThanOrEqualWhenEqualDateTimeReturnCorrectValueAndValueType()
        {
            // Given 
        ...
        [Fact]
        public void DateTimeGreaterThanOrEqualNullFunctionDefaultOption()
        {
            GreaterThanOrEqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(DateTime.Today, TokenType.Datetime);
        ...
        [Fact]
        public void DateTimeGreaterThanOrEqualNullFunctionPropgateOption()
        {
            GreaterThanOrEqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(DateTime.Today, TokenType.Datetime);
            var operand2 = new Token(null, TokenType.NULL);
        ...
        [Fact]
        public void DateTimeGreaterThanOrEqualNullFunctionThrowOption()
        {
            GreaterThanOrEqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(DateTime.Today, TokenType.Datetime);
            var operand2 = new Token(null, TokenType.NULL);
