...
public class DoubleDivideOperatorUnitTest
{
    [Fact]
    public void DoubleDivideByteReturnCorrectValueAndValueType()
    {
    ...
    [Fact]
    public void DoubleDivideIntegerFunctionReturnCorrectValueAndValueType()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
    ...
    [Fact]
    public void DoubleDivideLongFunctionReturnCorrectValueAndValueType()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
        var operand1 = new Token(200.0, TokenType.Double);
    ...
    [Fact]
    public void DoubleDivideFloatFunctionReturnCorrectValueAndValueType()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
        var operand1 = new Token(200.0, TokenType.Double);
    ...
    [Fact]
    public void DoubleDivideDecimalFunctionReturnCorrectValueAndValueType()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
        var operand1 = new Token(200.0, TokenType.Double);
    ...
    [Fact]
    public void DoubleDivideDoubleFunctionReturnCorrectValueAndValueType()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
        var operand1 = new Token(200.0, TokenType.Double);
    ...
    [Fact]
    public void DoubleDivideZeroFunctionReturnCorrectValueAndValueType()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
        var operand1 = new Token(200.0, TokenType.Double);
    ...
    [Fact]
    public void DoubleDivideNullFunctionDefaultOption()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
        var operand1 = new Token(200.0, TokenType.Double);
    ...
    [Fact]
    public void DoubleDivideNullFunctionPropgateOption()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
        var operand1 = new Token(200.0, TokenType.Double);
        var operand2 = new Token(null, TokenType.NULL);
    ...
    [Fact]
    public void DoubleDivideNullFunctionThrowOption()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
        var operand1 = new Token(200.0, TokenType.Double);
        var operand2 = new Token(null, TokenType.NULL);
    ...
    [Fact]
    public void DoubleDivideOtherTypesFunctionThrowOption()
    {
        DivideOperatorOverloads divideOperatorOverloads = new();
        var operand1 = new Token(200.0, TokenType.Double);
