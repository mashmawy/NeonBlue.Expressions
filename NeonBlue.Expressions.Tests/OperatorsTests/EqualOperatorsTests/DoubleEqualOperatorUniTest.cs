...
{
    public class DoubleEqualOperatorUniTest
    {
        [Fact]
        public void DoubleEqualByteReturnCorrectValueAndValueType()
        {
            // Given 
        ...
        [Fact]
        public void DoubleEqualIntegerReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2.0, TokenType.Double);
        ...
        [Fact]
        public void DoubleEqualLongReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2.0, TokenType.Double);
        ...
        [Fact]
        public void DoubleEqualFloatReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2.0, TokenType.Double);
        ...
        [Fact]
        public void DoubleEqualDoubleReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2.0, TokenType.Double);
        ...
        [Fact]
        public void DoubleEqualDecimalReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2.0, TokenType.Double);
        ...
        [Fact]
        public void DoubleEqualNullFunctionDefaultOption()
        {
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2.0, TokenType.Double);
        ...
        [Fact]
        public void DoubleEqualNullFunctionPropgateOption()
        {
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2.0, TokenType.Double);
            var operand2 = new Token(null, TokenType.NULL);
        ...
        [Fact]
        public void DoubleEqualNullFunctionThrowOption()
        {
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2.0, TokenType.Double);
            var operand2 = new Token(null, TokenType.NULL);
