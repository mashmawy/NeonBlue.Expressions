...
{
    public class FloatEqualOperatorUniTest
    {
        [Fact]
        public void FloatEqualByteReturnCorrectValueAndValueType()
        {
            // Given 
        ...
        [Fact]
        public void FloatEqualIntegerReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2f, TokenType.Float);
        ...
        [Fact]
        public void FloatEqualLongReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2f, TokenType.Float);
        ...
        [Fact]
        public void FloatEqualFloatReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2f, TokenType.Float);
        ...
        [Fact]
        public void FloatEqualDoubleReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2f, TokenType.Float);
        ...
        [Fact]
        public void FloatEqualDecimalReturnCorrectValueAndValueType()
        {
            // Given 
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2f, TokenType.Float);
        ...
        [Fact]
        public void FloatEqualNullFunctionDefaultOption()
        {
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2f, TokenType.Float);
        ...
        [Fact]
        public void FloatEqualNullFunctionPropgateOption()
        {
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2f, TokenType.Float);
            var operand2 = new Token(null, TokenType.NULL);
        ...
        [Fact]
        public void FloatEqualNullFunctionThrowOption()
        {
            EqualOperatorOverloads equalOperatorOverloads = new();
            var operand1 = new Token(2f, TokenType.Float);
            var operand2 = new Token(null, TokenType.NULL);
