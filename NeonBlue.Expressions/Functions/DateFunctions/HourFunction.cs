...
{
    /// <summary>
    /// Represents the Hour function for extracting the hour from a date and time value.
    /// </summary>
    public class HourFunction : StackUpdateFunction
    {
        ...
        /// <summary>
        /// Updates the stack by extracting the hour from the top date and time value.
        /// </summary>
        ...
        public override void Update(Stack<Token> tokensStack, IExecutionOptions executionOptions)
        {
            ...
            tokensStack.Push(new Token(arg1.Hour));
        }
    }
}