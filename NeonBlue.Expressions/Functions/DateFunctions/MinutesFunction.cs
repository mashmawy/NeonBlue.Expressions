...
{
    /// <summary>
    /// Represents the Minutes function for extracting the minute from a date and time value.
    /// </summary>
    public class MinutesFunction : StackUpdateFunction
    {
        /// <summary>
        /// Gets the name of the function.
        /// </summary>
        public override string FunctionName => "minutes";

        /// <summary>
        /// Updates the stack by extracting the minute from the top date and time value.
        /// </summary>
        ...
        public override void Update(Stack<Token> tokensStack, IExecutionOptions executionOptions)
        {
            ...
            tokensStack.Push(new Token(arg1.Minute));
        }
    }
}