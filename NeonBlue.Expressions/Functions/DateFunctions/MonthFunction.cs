...
{
    /// <summary>
    /// Represents the Month function for extracting the month from a date and time value.
    /// </summary>
    public class MonthFunction : StackUpdateFunction
    {
        ...
        /// <summary>
        /// Updates the stack by extracting the month from the top date and time value.
        /// </summary>
        ...
        public override void Update(Stack<Token> tokensStack, IExecutionOptions executionOptions)
        {
            ...
            tokensStack.Push(new Token(arg1.Month));
        }
    }
}