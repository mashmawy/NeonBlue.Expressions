...
{
    /// <summary>
    /// Represents the Seconds function for extracting the seconds from a date and time value.
    /// </summary>
    public class SecondsFunction : StackUpdateFunction
    {
        ...
        /// <summary>
        /// Updates the stack by extracting the seconds from the top date and time value.
        /// </summary>
        ...
        public override void Update(Stack<Token> tokensStack, IExecutionOptions executionOptions)
        {
            ...
            tokensStack.Push(new Token(arg1.Second));
        }
    }
}