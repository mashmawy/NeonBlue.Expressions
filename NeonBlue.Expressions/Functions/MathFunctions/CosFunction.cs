...
{
    /// <summary>
    /// Represents the Cos function for calculating the cosine of a number.
    /// </summary>
    public class CosFunction : StackUpdateFunction
    {
        ...
        /// <summary>
        /// Updates the stack by calculating the cosine of the top numeric value.
        /// </summary>
        ...
        /// <exception cref="MathException">Thrown if the cosine operation fails.</exception>
                    ...
                    case TokenType.Integer:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Cos(val)));
                            break;
                        }
                    ...
                    case TokenType.Decimal:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Cos((double)val)));
                            break;
                        }
