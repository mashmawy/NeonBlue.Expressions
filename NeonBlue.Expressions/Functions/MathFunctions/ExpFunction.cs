...
{
    /// <summary>
    /// Represents the Exp function for calculating the exponential of a number.
    /// </summary>
    public class ExpFunction : StackUpdateFunction
    {
        /// <summary>
        /// Gets the name of the function.
        /// </summary>
        public override string FunctionName => "exp";

        /// <summary>
        /// Updates the stack by calculating the exponential of the top numeric value.
        /// </summary>
        ...
        /// <exception cref="MathException">Thrown if the exponential operation fails.</exception>
                    ...
                    case TokenType.Integer:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Exp(val)));
                            break;
                        }
                    ...
                    case TokenType.Decimal:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Exp((double)val)));
                            break;
                        }
