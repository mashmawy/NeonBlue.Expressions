...
{
    /// <summary>
    /// Represents the Cosh function for calculating the hyperbolic cosine of a number.
    /// </summary>
    public class CoshFunction : StackUpdateFunction
    {
        /// <summary>
        /// Gets the name of the function.
        /// </summary>
        public override string FunctionName => "cosh";

        /// <summary>
        /// Updates the stack by calculating the hyperbolic cosine of the top numeric value.
        /// </summary>
        ...
        /// <exception cref="MathException">Thrown if the hyperbolic cosine operation fails.</exception>
                    ...
                    case TokenType.Integer:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Cosh(val)));
                            break;
                        }
                    ...
                    case TokenType.Decimal:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Cosh((double)val)));
                            break;
                        }
