...
{
    /// <summary>
    /// Represents the Sqrt function for calculating the square root of a number.
    /// </summary>
    public class SqrtFunction : StackUpdateFunction
    {
        /// <summary>
        /// Gets the name of the function.
        /// </summary>
        public override string FunctionName => "sqrt";

        /// <summary>
        /// Updates the stack by calculating the square root of the top numeric value.
        /// </summary>
        ...
        /// <exception cref="MathException">Thrown if the square root operation fails.</exception>
                    ...
                    case TokenType.Integer:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Sqrt(val)));
                            break;
                        }
                    ...
                    case TokenType.Decimal:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Sqrt((double)val)));
                            break;
                        }
