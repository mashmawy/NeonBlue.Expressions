...
{
    /// <summary>
    /// Represents the Tan function for calculating the tangent of a number.
    /// </summary>
    public class TanFunction : StackUpdateFunction
    {
        /// <summary>
        /// Gets the name of the function.
        /// </summary>
        public override string FunctionName => "tan";

        /// <summary>
        /// Updates the stack by calculating the tangent of the top numeric value.
        /// </summary>
        ...
        /// <exception cref="MathException">Thrown if the tangent operation fails.</exception>
                    ...
                    case TokenType.Integer:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Tan(val)));
                            break;
                        }
                    ...
                    case TokenType.Decimal:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Tan((double)val)));
                            break;
                        }
