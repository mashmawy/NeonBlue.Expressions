...
{
    /// <summary>
    /// Represents the Sin function for calculating the sine of a number.
    /// </summary>
    public class SinFunction : StackUpdateFunction
    {
        /// <summary>
        ...
        /// <summary>
        /// Updates the stack by calculating the sine of the top numeric value.
        /// </summary>
        ...
        /// <exception cref="MathException">Thrown if the sine operation fails.</exception>
                    ...
                    case TokenType.Integer:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Sin(val)));
                            break;
                        }
                    ...
                    case TokenType.Decimal:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Sin((double)val)));
                            break;
                        }
