...
{
    /// <summary>
    /// Represents the Acos function for calculating the arccosine of a number.
    /// </summary>
    public class AcosFunction : StackUpdateFunction
    {
        ...
        /// <summary>
        /// Updates the stack by calculating the arccosine of the top numeric value.
        /// </summary>
        ...
        /// <exception cref="MathException">Thrown if the arccosine operation fails.</exception>
                    ...
                    case TokenType.Integer:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Acos(val)));
                            break;
                        }
                    ...
                    case TokenType.Decimal:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Acos((double)val)));
                            break;
                        }
