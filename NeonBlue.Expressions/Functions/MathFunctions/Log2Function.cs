...
{
    /// <summary>
    /// Represents the Log2 function for calculating the base-2 logarithm of a number.
    /// </summary>
    public class Log2Function : StackUpdateFunction
    {
        /// <summary>
        /// Gets the name of the function.
        /// </summary>
        public override string FunctionName => "log2";

        /// <summary>
        /// Updates the stack by calculating the base-2 logarithm of the top numeric value.
        /// </summary>
        ...
        /// <exception cref="MathException">Thrown if the base-2 logarithm operation fails.</exception>
                    ...
                    case TokenType.Integer:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Log2(val)));
                            break;
                        }
                    ...
                    case TokenType.Decimal:
                        {
                            ...
                            tokensStack.Push(new Token(Math.Log2((double)val)));
                            break;
                        }
