...
{
    /// <summary>
    /// Represents the Left function for extracting a substring from the left side of a string.
    /// </summary>
    public class LeftFunction : StackUpdateFunction
    {
        /// <summary>
        /// Gets the name of the function.
        /// </summary>
        public override string FunctionName => "left";

        /// <summary>
        /// Updates the stack by extracting a substring from the left side of the top string value.
        /// </summary>
        ...
        /// <exception cref="StringException">Thrown if the left operation fails.</exception>
