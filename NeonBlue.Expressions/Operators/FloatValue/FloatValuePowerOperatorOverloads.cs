...
{
    /// <summary>
    /// Represents the operator overloads for the power operator (^) when the left operand is a float value.
    /// </summary>
    public class FloatValuePowerOperatorOverloads : OperatorsOverload
    {
        /// <summary>
        ...
        public override Dictionary<TokenType, Func<Token, Token, IExecutionOptions, Token>> GetOverloads()
        {
            ...
            if (overloads.Count == 0)
            {
                ...
                overloads.Add(TokenType.NULL, FloatPowerNull);
            }
        ...
        private static Token FloatPowerNull(Token a1, Token a2, IExecutionOptions executionOptions)
        {
