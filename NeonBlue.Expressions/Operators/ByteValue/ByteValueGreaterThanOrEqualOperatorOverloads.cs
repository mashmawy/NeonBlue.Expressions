...
{
    /// <summary>
    /// Represents the operator overloads for greater than or equal to comparisons involving Byte values.
    /// </summary>
    public class ByteValueGreaterThanOrEqualOperatorOverloads : OperatorsOverload
    {
        /// <summary>
        ...
        private static Token ByteGreaterThanOrEqualInteger(Token a1, Token a2, IExecutionOptions executionOptions)
        {
        ...
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the greater than or equal to comparison.</returns>
        private static Token ByteGreaterThanOrEqualLong(Token a1, Token a2, IExecutionOptions executionOptions)
        {
            var arg1 = Convert.ToByte(a1.Value);
        ...
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the greater than or equal to comparison.</returns>
        private static Token ByteGreaterThanOrEqualDecimal(Token a1, Token a2, IExecutionOptions executionOptions)
        {
            var arg1 = Convert.ToByte(a1.Value);
        ...
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the greater than or equal to comparison.</returns>
        private static Token ByteGreaterThanOrEqualDouble(Token a1, Token a2, IExecutionOptions executionOptions)
        {
            var arg1 = Convert.ToByte(a1.Value);
        ...
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the greater than or equal to comparison.</returns>
        private static Token ByteGreaterThanOrEqualFloat(Token a1, Token a2, IExecutionOptions executionOptions)
        {
            var arg1 = Convert.ToByte(a1.Value);
        ...
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the greater than or equal to comparison.</returns>
        private static Token ByteGreaterThanOrEqualNull(Token a1, Token a2, IExecutionOptions executionOptions)
        {
