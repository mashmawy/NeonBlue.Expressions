...
{
    /// <summary>
    /// Represents the operator overloads for less than comparisons involving DateTime values.
    /// </summary>
    public class DatetimeValueLessThanOperatorOverloads : OperatorsOverload
    {
        /// <summary>
        ...
        public override Dictionary<TokenType, Func<Token, Token, IExecutionOptions, Token>> GetOverloads()
        {
            ...
            {
                overloads.Add(TokenType.Datetime, DatetimeLessThanDatetime);
        ...
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the less than comparison.</returns>
        private static Token DatetimeLessThanDatetime(Token a1, Token a2, IExecutionOptions executionOptions)
        {
