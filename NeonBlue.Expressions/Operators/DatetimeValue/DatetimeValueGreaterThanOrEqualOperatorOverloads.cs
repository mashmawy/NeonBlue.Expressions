...
{
    /// <summary>
    /// Represents the operator overloads for greater than or equal to comparisons involving DateTime values.
    /// </summary>
    public class DatetimeValueGreaterThanOrEqualOperatorOverloads : OperatorsOverload
    {
        /// <summary>
        ...
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the greater than or equal to comparison.</returns>
        private static Token DatetimeGreaterThanOrEqualDatetime(Token a1, Token a2, IExecutionOptions executionOptions)
        {
