...
{
    /// <summary>
    /// Represents the operator overloads for equality comparisons involving String values.
    /// </summary>
    public class StringValueEqualOperatorOverloads : OperatorsOverload
    {
        /// <summary>
        ...
        public override Dictionary<TokenType, Func<Token, Token, IExecutionOptions, Token>> GetOverloads()
        {
            ...
            {
                overloads.Add(TokenType.String, StringEqualString);
        ...
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the equality comparison.</returns>
        private static Token StringEqualString(Token a1, Token a2, IExecutionOptions executionOptions)
        {
