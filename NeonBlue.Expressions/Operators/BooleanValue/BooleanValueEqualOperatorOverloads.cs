...
{
    /// <summary>
    /// Represents the operator overloads for equality comparisons involving Boolean values.
    /// </summary>
    public class BooleanValueEqualOperatorOverloads : OperatorsOverload
    {
        /// <summary>
        ...
        private static Token BooleanEqualNull(Token a1, Token a2, IExecutionOptions executionOptions)
        {
        ...
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the equality comparison.</returns>
        private static Token BooleanEqualBoolean(Token a1, Token a2, IExecutionOptions executionOptions)
        {
