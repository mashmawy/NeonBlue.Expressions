...
{
    /// <summary>
    /// Represents the operator overloads for the power operator (^) when the left operand is a long value.
    /// </summary>
    public class LongValuePowerOperatorOverloads : OperatorsOverload
    {
        /// <summary>
        ...
        public override Dictionary<TokenType, Func<Token, Token, IExecutionOptions, Token>> GetOverloads()
        {
            ...
            if (overloads.Count == 0)
            {
                ...
                overloads.Add(TokenType.NULL, LongPowerNull);
            }
        ...
        private static Token LongPowerNull(Token a1, Token a2, IExecutionOptions executionOptions)
        {
