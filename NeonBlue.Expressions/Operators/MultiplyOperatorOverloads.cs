...
namespace NeonBlue.Expressions.Operators
{
    ...
    public class MultiplyOperatorOverloads : IOperator
    {
        ...
        {
            IntegerValue_MultiplyOperatorOverloads overloads = new();
        ...
        {
            LongValue_MultiplyOperatorOverloads overloads = new();
        ...
        {
            FloatValue_MultiplyOperatorOverloads overloads = new();
