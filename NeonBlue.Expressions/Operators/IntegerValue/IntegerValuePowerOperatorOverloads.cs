...
{
    /// <summary>
    /// Represents the operator overloads for the power operator (^) when the left operand is a int value.
    /// </summary>
    public class IntegerValuePowerOperatorOverloads : OperatorsOverload
    {
        /// <summary>
        ...
        public override Dictionary<TokenType, Func<Token, Token, IExecutionOptions, Token>> GetOverloads()
        {
            ...
            if (overloads.Count == 0)
            {
                ...
                overloads.Add(TokenType.NULL, IntegerPowerNull);
            }
        ...
        /// <summary>
        /// Handles the case where one operand is int and the other is null.
        /// </summary>
        /// <param name="a1">The first operand.</param>
        /// <param name="a2">The second operand.</param>
        /// <param name="executionOptions">The execution options.</param>
        /// <returns>The result of the power operation.</returns>
        private static Token IntegerPowerNull(Token a1, Token a2, IExecutionOptions executionOptions)
        {
